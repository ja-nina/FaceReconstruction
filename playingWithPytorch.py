...
#         self.files = self.files[:] if mode == "train" else self.files[-12:]
...
if __name__ == '__main__':
    MyExperiment = Experiment(name = 'Basic_see_if_works', overfittingStudy= True)
    ...
    #     ImageDataset(dataset_name, transforms_=transforms_, overfittingStudy= True),
    #     batch_size=batch_size,
    #     shuffle=True,
    #     num_workers=n_cpu,
    # )
    # test_dataloader = DataLoader(
    #     ImageDataset(dataset_name, transforms_=transforms_, mode="val", overfittingStudy=True),
    #     batch_size=12,
    #     shuffle=True,
    #     num_workers=1,
    # )
    ...
    generator, discriminator, optimizer_G, optimizer_D = MyExperiment.set_up()
    ...
    # adversarial_loss, pixelwise_loss = MyExperiment.get_loss()
    # generator, discriminator = MyExperiment.get_Generator(), MyExperiment.get_Discriminator() 
    #optimizer_D, optimizer_G = MyExperiment.set_up()
